...
stdenv.mkDerivation rec {
  ...
  installPhase = ''
    ...
    echo "DOMINO_ENABLED=true" > $out/etc/raychd/envs/dacko/.env
    echo "DOMINO_VERSION=1.0.0" >> $out/etc/raychd/envs/dacko/.env
    echo "DOMINO_DAEMON_MODE=true" >> $out/etc/raychd/envs/dacko/.env
  '';
